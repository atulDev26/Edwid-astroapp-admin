...
const CallHistory = () => {
    ...
    const stats = [
        {
            label: 'TOTAL CALL SESSION',
            value: '12,842',
            icon: <IconPhone size={24} className="text-white" />,
            iconBg: 'bg-[#0A0E27]'
        },
        {
    ...
    const columns = [
        {
            name: 'SL NO',
            width: '60px',
            cell: (row: CallSession) => <span className="font-bold text-[#0A0E27] text-[13px]">{row.slNo}</span>
        },
        {
            name: 'USER PROFILE',
            width: '150px',
            cell: (row: CallSession) => {
        ...
        },
        {
            name: 'AMOUNT',
            width: '100px',
            cell: (row: CallSession) => <span className="font-bold text-[#0A0E27] text-[13px]">{row.amount}</span>
        },
        {
            name: 'RATING',
            width: '110px',
